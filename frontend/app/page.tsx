    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
        ...
        <div id="features" className="grid md:grid-cols-2 lg:grid-cols-5 grid-rows-2 gap-6">
          {giftCat.map((item: GiftCategory, index: number) => (
            <div key={index} className="group">
              <div className="flex flex-col rounded-xl shadow-sm cursor-pointer border border-gray-200 hover:border-[#0FA47A] hover:-translate-y-1 transition-all duration-300 bg-white p-6 h-full">
                <div className="flex flex-col items-center text-center space-y-4">
                  <div className="w-16 h-16 bg-gradient-to-br from-emerald-100 to-emerald-200 rounded-full flex items-center justify-center group-hover:from-emerald-200 group-hover:to-emerald-300 transition-all duration-300">
                    <span className="text-3xl">{item.icon}</span>
                  </div>
                  <span className="text-gray-800 group-hover:text-[#0FA47A] text-lg font-semibold transition-colors duration-300 leading-tight">
                    {item.title}
                  </span>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-[#0FA47A]/20 to-[#16BFA8]/20 rounded-full blur-xl group-hover:blur-2xl transition-all duration-500"></div>
                <div className="relative bg-white rounded-2xl shadow-lg border border-gray-200 p-8 group-hover:shadow-2xl group-hover:-translate-y-2 transition-all duration-300">
                  <div className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-[#0FA47A] to-[#16BFA8] bg-clip-text text-transparent mb-2">
                    10M+
                  </div>
      ...
      <Container className="py-16">
          ...
          <div className="flex items-center bg-gray-100 border border-gray-200 rounded-full p-1 shadow-sm">
            <button
              className={`px-8 py-3 rounded-full font-semibold text-sm transition-all duration-300 cursor-pointer ${
                toggleBtn
                  ? 'bg-[#0FA47A] text-white shadow-md'
                  : 'text-gray-600 hover:text-[#0FA47A]'
              }`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {toggleBtn ? howItWorksForGift.map((item: forGift, index: number) => (
            <div key={index} className="group bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-xl hover:border-[#0FA47A] transition-all duration-300 overflow-hidden">
              <div className="cursor-pointer">
                ...
                <div className="p-6">
                  <h3 className="text-gray-900 text-xl font-semibold mb-3 group-hover:text-[#0FA47A] transition-colors duration-300">
                    {item.title}
                  </h3>
                  ...
                  <Button
                    title={item.btnTitle}
                    path={item.path}
                    className="w-full bg-gradient-to-r from-[#0FA47A] to-[#16BFA8] hover:from-[#16BFA8] hover:to-[#0FA47A] text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="group text-center">
              <div className="relative mb-6">
                <div className="absolute inset-0 bg-gradient-to-r from-[#0FA47A]/20 to-[#16BFA8]/20 rounded-full blur-xl group-hover:blur-2xl transition-all duration-500"></div>
                <div className="relative w-20 h-20 bg-gradient-to-br from-emerald-100 to-emerald-200 rounded-2xl flex items-center justify-center mx-auto group-hover:from-emerald-200 group-hover:to-emerald-300 transition-all duration-300">
                  <svg className="w-10 h-10 text-[#0FA47A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-3 group-hover:text-[#0FA47A] transition-colors duration-300">
                Lightning Fast
              </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="group bg-white rounded-2xl shadow-lg border border-gray-200 p-8 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="flex items-center">
              <div className="w-12 h-12 bg-gradient-to-br from-[#0FA47A] to-[#16BFA8] rounded-full flex items-center justify-center text-white font-bold">
                SJ
              </div>
              <div className="ml-4">
      ...
      <Container className="py-16">
        <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl shadow-2xl overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-[#0FA47A]/10 to-transparent"></div>
          <div className="relative flex flex-col lg:flex-row justify-between items-center p-12 lg:p-16">
            <div className="w-full lg:w-[55%] mb-8 lg:mb-0">
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 lg:p-12 shadow-2xl">
                <h1 className="text-4xl lg:text-5xl font-semibold mb-6 text-white leading-tight">
                  Get insights into{' '}
                  <span className="bg-gradient-to-r from-[#0FA47A] to-[#16BFA8] bg-clip-text text-transparent">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 max-w-2xl">
                  <div className="flex-1 relative">
                    <input
                      ...
                      className="w-full px-6 py-4 bg-white/90 backdrop-blur-sm border border-gray-200 rounded-xl outline-none text-gray-800 placeholder-gray-500 focus:ring-2 focus:ring-[#0FA47A] focus:border-transparent transition-all duration-300"
                      required
                    />
                  </div>
                  <Button
                    title="Get insights"
                    path="/"
                    className="bg-gradient-to-r from-[#0FA47A] to-[#16BFA8] hover:from-[#16BFA8] hover:to-[#0FA47A] text-white font-semibold px-8 py-4 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-[40%] flex justify-center items-center">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-[#0FA47A]/20 to-[#16BFA8]/20 rounded-full blur-3xl transform rotate-12"></div>
                <Image
                  src="/gift.png"
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
              <div className="flex flex-col sm:flex-row gap-4">
                <input
                  type="email"
                  placeholder="Enter your email address"
                  className="flex-1 px-6 py-4 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-[#0FA47A] focus:border-transparent transition-all duration-300"
                  required
                />
                <Button
                  title="Join Waitlist"
                  path="/"
                  className="bg-gradient-to-r from-[#0FA47A] to-[#16BFA8] hover:from-[#16BFA8] hover:to-[#0FA47A] text-white font-semibold px-8 py-4 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl"
                />
              </div>

              <div className="flex flex-wrap justify-center gap-6 mt-8 pt-6 border-t border-gray-100">
                <span className="text-sm text-gray-500">Follow us:</span>
                <Link href="/" className="text-gray-600 hover:text-[#0FA47A] transition-colors duration-300">
          ...
          <div className="space-y-6">
            <div className="group bg-white rounded-2xl shadow-lg border border-gray-200 p-8 hover:shadow-2xl transition-all duration-300">
              <div className="flex items-start justify-between">
                ...
                <div className="ml-6 group-hover:text-[#0FA47A] transition-colors duration-300">
            ...
            {cardData.map((card, idx) => (
              <div
                ...
                className={`group relative bg-white rounded-2xl shadow-lg border transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 ${
                  card.label === 'Popular'
                    ? 'border-[#0FA47A] ring-2 ring-emerald-100 scale-105'
                    : 'border-gray-200 hover:border-[#0FA47A]'
                }`}
              >
                {card.label === 'Popular' && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <span className="bg-gradient-to-r from-[#0FA47A] to-[#16BFA8] text-white px-6 py-2 rounded-full text-sm font-semibold shadow-lg">
                      Most Popular
                    </span>
                  </div>
                )}
                ...
                <div className="p-8">
                    ...
                    {card.list.map((item, itemIdx) => (
                      <li key={itemIdx} className="flex items-start space-x-3">
                        <div className="w-5 h-5 bg-emerald-100 rounded-full flex items-center justify-center mt-0.5 flex-shrink-0">
                          <svg className="w-3 h-3 text-[#0FA47A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <Button
                    ...
                    className={`w-full py-3 px-6 rounded-xl font-semibold transition-all duration-300 ${
                      card.label === 'Popular'
                        ? 'bg-gradient-to-r from-[#0FA47A] to-[#16BFA8] hover:from-[#16BFA8] hover:to-[#0FA47A] text-white shadow-lg hover:shadow-xl transform hover:-translate-y-0.5'
